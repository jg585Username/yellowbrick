...
class TestClassificationReport(VisualTestCase):
    ...
    def test_multiclass_class_report(self):
        ...
        assert viz.scores_ == {
            "precision": {
                0: approx(0.75),
                1: approx(0.47368421052631576),
                2: approx(0.45),
                3: approx(0.375),
                4: approx(0.5),
                5: approx(0.5294117647058824),
            },
            "recall": {
                0: approx(0.47368421052631576),
                1: approx(0.5625),
                2: approx(0.6428571428571429),
                3: approx(0.3157894736842105),
                4: approx(0.5),
                5: approx(0.5625),
            },
            "f1": {
                0: approx(0.5806451612903226),
                1: approx(0.5142857142857142),
                2: approx(0.5294117647058824),
                3: approx(0.34285714285714286),
                4: approx(0.5),
                5: approx(0.5454545454545455),
            },
        }
